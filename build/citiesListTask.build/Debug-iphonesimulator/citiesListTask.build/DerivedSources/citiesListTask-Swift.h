...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="citiesListTask",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14citiesListTask11AppDelegate")
...
SWIFT_CLASS("_TtC14citiesListTask18BaseViewController")
...
SWIFT_CLASS("_TtC14citiesListTask19CitiesTableViewCell")
@interface CitiesTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified cityNameLbl;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified cityStaticImageView;
...
SWIFT_CLASS("_TtC14citiesListTask16MainCitiesListVC")
@interface MainCitiesListVC : BaseViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified citiesTableView;
...
@interface MainCitiesListVC (SWIFT_EXTENSION(citiesListTask)) <UISearchBarDelegate>
- (void)searchBarSearchButtonClicked:(UISearchBar * _Nonnull)searchBar;
- (void)searchBar:(UISearchBar * _Nonnull)searchBar textDidChange:(NSString * _Nonnull)searchText;
@end


@interface MainCitiesListVC (SWIFT_EXTENSION(citiesListTask)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC14citiesListTask13SceneDelegate")
